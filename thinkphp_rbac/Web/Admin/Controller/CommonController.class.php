...
class CommonController extends Controller{
	...
	public function _initialize(){
		...
		//判断当前用户是否拥有当前操作权限
		$contr = strtolower(CONTROLLER_NAME); //获取控制器名
		$action = strtolower(ACTION_NAME); //获取控制器中的方法名
		$nolist = $_SESSION[C('USER_AUTH_KEY')]['nodelist'];
		if(empty($nolist[$contr]) || !in_array($action,$nolist[$contr])){
			$this->error("抱歉没有此管理权限");
			exit();
		}
